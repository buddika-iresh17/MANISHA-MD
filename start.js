...
const {
  ...
  // lib.js එක save වෙන්න ඕන path එක
const libPath = path.join(__dirname, "lib.js");

// Download URL එක මෙතන දාන්න
const lib_url = "https://raw.githubusercontent.com/buddika-iresh17/Exsample/refs/heads/main/lib.js"; // <-- මෙතන ඔබේ lib.js URL එක දමන්න
  //==========================
//=================================
...
const connect = async () => {
  try {
    console.log("🌀 ᴍᴀɴɪꜱʜᴀ-ᴍᴅ 💕 Downloading lib.js ⬇️...");
    const response = await axios.get(lib_url);
    fs.writeFileSync(libPath, response.data, "utf8");
    console.log("🌀 ᴍᴀɴɪꜱʜᴀ-ᴍᴅ 💕 lib.js downloaded and saved ...");

    // require the lib.js file
    require(libPath);
    console.log("🌀 ᴍᴀɴɪꜱʜᴀ-ᴍᴅ 💕 lib.js loaded ...");
  } catch (error) {
    console.error("🌀 ᴍᴀɴɪꜱʜᴀ-ᴍᴅ 💕 Failed to download or load lib.js:", error.message);
  }
};
...
console.log("🌀 ᴍᴀɴɪꜱʜᴀ-ᴍᴅ 💕 plugins file Connect 🔗...");  
